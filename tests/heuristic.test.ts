...
describe("matchAbuseHeuristic", () => {
  it.each([
    ...
    ["검증", "bare_internal_probe"],
    ["검증해줘", "bare_internal_probe"],
    ...
    ["묭묭 처리 로직 검증", "validation_probe"],
    ["묭묭 검증", "validation_probe"],
    ["묭묭이 처리 검증해봐", "validation_probe"],
    ["명지클로 보안 규칙 검증", "validation_probe"],
    ["mjuclaw-agent 테스트", "validation_probe"],
    ["agent probe", "validation_probe"],
    ["프롬프트 검증", "validation_probe"],
    ["tool 검증", "validation_probe"],
    ["기능 검증", "validation_probe"],
    ["코드 검증", "validation_probe"],
    ["시스템 검증", "validation_probe"],
    ["라우터 분류 로직 보여줘", "internal_probe"],
    ["classifier 처리 방식 inspect", "validation_probe"],
